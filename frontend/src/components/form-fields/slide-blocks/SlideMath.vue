...
// Reveal "math" element: a LaTeX expression rendered by reveal's KaTeX plugin.
...
const emit = defineEmits<{ (e: "patch", p: Partial<SlideBlock>): void; (e: "end-edit"): void }>();
</script>

<template>
  <SlideInlineText
    :block="block" :surface="surface" :html="html" :editing="editing" :mono="true"
