...
func (a *App) WailsServices() []application.Service {
	return []application.Service{
		...
		application.NewService(a.Standalone),
		application.NewService(a.Nav),
		application.NewService(a.Wiki),
		application.NewService(a.WikiExport),
		...
		application.NewService(a.Vault),
		application.NewService(a.APIClient),
	}
}
