...
func TestListCollections_OmitsNonCollectionTemplates(t *testing.T) {
	h := NewHandler(newStub(), newStubStorage(), newStubWriter(), newStubTemplates(), nil)
...
func TestListCollections_NameFromYamlOrStem(t *testing.T) {
	...
	h := NewHandler(sp, newStubStorage(), newStubWriter(), newStubTemplates(), nil)
...
func TestPOST_RejectsExistingByDefault(t *testing.T) {
	...
	h := NewHandler(sp, newStubStorage(), newStubWriter(), tpl, nil)
...
func TestPOST_UpsertOverwrites(t *testing.T) {
	...
	h := NewHandler(sp, newStubStorage(), wr, tpl, nil)
...
func TestList_Default(t *testing.T) {
	h := NewHandler(newStubWithTags(), newStubStorage(), newStubWriter(), newStubTemplates(), nil)
