...
// storeFS is the filesystem surface the pdf module needs. ListDir returns
// an empty slice for a missing directory. ResolvePath maps a (possibly
// relative) input to its absolute path for the cover-logo resolver.
